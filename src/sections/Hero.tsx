  ...
  return (
    <section className="w-full h-full flex flex-col bg-heroMobile sm:bg-heroTablet lg:bg-heroDesktop bg-cover bg-center">
      <div className="container">
        ...
        <button
          type="button"
          className="text-black hover:text-[darkOrange] bg-[darkOrange] hover:bg-transparent border-2 hover:border-2 border-[black] hover:border-[darkOrange] text-[24px] w-[300px] rounded-[50px] py-4 flex items-center justify-center sm:mb-[150px] lg:mb-[267px] mt-[63px]"
        >
          Online-booking
        </button>
      </div>
